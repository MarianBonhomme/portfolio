...
export default function App() {
  ...
  return (
    <div className="bg-dark text-white text-shadow font-merriwether tracking-widest select-none relative">
      ...
      <Element id='section-1' className="section h-screen flex flex-col justify-center items-center relative z-10">
      ...
      <Element id='section-2' className="section h-screen flex justify-center items-center relative z-10">
        <SliderComponent />
      </Element>

      <Element id='section-3' className="section h-screen flex justify-center items-center relative z-10">
      ...
      <div className={`fixed top-0 h-screen w-screen z-50 bg-dark transition-all duration-300 ${isModalVisible ? 'translate-x-0' : '-translate-x-full'}`}>
